...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'codespace-dev.k3p.dev', 'anaheim-bottles-hop-delayed.trycloudflare.com', 'architecture-smooth-linked-bright.trycloudflare.com']
CSRF_TRUSTED_ORIGINS=['https://codespace-dev.k3p.dev', 'https://anaheim-bottles-hop-delayed.trycloudflare.com', 'https://architecture-smooth-linked-bright.trycloudflare.com']
# Database
DATABASES = {
    'default': {
        # for MySQl
